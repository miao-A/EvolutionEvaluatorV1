...
public class IntergrationDialog extends Dialog {
	...
	private void createContents() throws IOException {
		...
		fd_composite.bottom = new FormAttachment(0, 613);
		fd_composite.top = new FormAttachment(0);
		composite.setLayoutData(fd_composite);
		composite.setLayout(new FormLayout());
		
		IntegrationMenuComposite intergrationComposite = new IntegrationMenuComposite(composite , SWT.NONE);
		intergrationComposite.setLayoutData(new FormData());
